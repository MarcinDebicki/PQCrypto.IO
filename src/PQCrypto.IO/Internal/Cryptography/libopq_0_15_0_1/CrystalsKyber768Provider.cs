...
internal sealed class CrystalsKyber768Provider : IKeyEncapsulationProvider
{
    ...
    public IKeyEncapsulationResult Decapsulation(in IKeyEncapsulationCiphertext keyEncapsulationCiphertext, in IKeyEncapsulationPrivateKey keyEncapsulationPrivateKey)
    {
        ...
        var plainSessionKey = new byte[OQS_KEM_KYBER_768_LENGTH_SHARED_SECRET];
    ...
    public IKeyEncapsulationKeyPair GenerateKeyPair()
    {
        ...
        var privateKey = new byte[OQS_KEM_KYBER_768_LENGTH_SECRET_KEY];
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_KEM_ml_kem_768_decaps(byte[] plainSessionKey, byte[] secretSessionKey, byte[] privateKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_ml_kem_768_encaps(byte[] secretSessionKey, byte[] plainSessionKey, byte[] publicKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_ml_kem_768_keypair(byte[] publicKey, byte[] privateKey);
    }
