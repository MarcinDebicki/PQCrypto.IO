...
internal sealed class ClassicMcEliece348864Provider : IKeyEncapsulationProvider
{
    ...
    private static readonly int OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_CIPHERTEXT = 96;
    private static readonly int OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_PUBLIC_KEY = 261120;
    private static readonly int OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_SECRET_KEY = 6492;
    ...
    static ClassicMcEliece348864Provider()
    {
        ...
        {
            DecapsMethod = Windows.OQS_KEM_classic_mceliece_348864_decaps;
            EncapsMethod = Windows.OQS_KEM_classic_mceliece_348864_encaps;
            GenerateKeypairMethod = Windows.OQS_KEM_classic_mceliece_348864_keypair;
        ...
        {
            DecapsMethod = Linux.OQS_KEM_classic_mceliece_348864_decaps;
            EncapsMethod = Linux.OQS_KEM_classic_mceliece_348864_encaps;
            GenerateKeypairMethod = Linux.OQS_KEM_classic_mceliece_348864_keypair;
    ...
    public IKeyEncapsulationResult Decapsulation(in IKeyEncapsulationCiphertext keyEncapsulationCiphertext, in IKeyEncapsulationPrivateKey keyEncapsulationPrivateKey)
    {
        ...
        keyEncapsulationPrivateKey.Value.RequireExactLength(nameof(keyEncapsulationPrivateKey.Value.Length), OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_SECRET_KEY);

        var plainSessionKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_SHARED_SECRET);
    ...
    public IKeyEncapsulationResult Encapsulation(in IKeyEncapsulationPublicKey publicKey)
    {
        ...
        var secretSessionKey = new byte[OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_CIPHERTEXT];
        var plainSessionKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_SHARED_SECRET);
        var apiResult = -1;
    ...
    {
        var publicKey = new byte[OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_PUBLIC_KEY];
        var privateKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_348864_LENGTH_SECRET_KEY);
        var apiResult = -1;
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_KEM_classic_mceliece_348864_decaps(IntPtr plainSessionKey, byte[] secretSessionKey, IntPtr privateKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.StdCall)]
        internal static extern int OQS_KEM_classic_mceliece_348864_encaps(byte[] secretSessionKey, IntPtr plainSessionKey, byte[] publicKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.StdCall)]
        internal static extern int OQS_KEM_classic_mceliece_348864_keypair(byte[] publicKey, IntPtr privateKey);
    }
