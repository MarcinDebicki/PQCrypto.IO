...
internal sealed class FalconPadded1024Provider : IDigitalSignatureProvider
{
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_SIG_falcon_padded_1024_keypair(byte[] publicKey, IntPtr secretKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_SIG_falcon_padded_1024_sign(byte[] signature, ref nuint signatureLen, byte[] message, nuint messageLen, IntPtr secretKey);
