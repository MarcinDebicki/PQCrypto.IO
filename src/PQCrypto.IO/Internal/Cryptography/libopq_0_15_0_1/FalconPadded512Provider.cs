...
internal sealed class FalconPadded512Provider : IDigitalSignatureProvider
{
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_SIG_falcon_padded_512_keypair(byte[] publicKey, IntPtr secretKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_SIG_falcon_padded_512_sign(byte[] signature, ref nuint signatureLen, byte[] message, nuint messageLen, IntPtr secretKey);
