...
internal sealed class ClassicMcEliece6688128Provider : IKeyEncapsulationProvider
{
    ...
    public IKeyEncapsulationResult Decapsulation(in IKeyEncapsulationCiphertext keyEncapsulationCiphertext, in IKeyEncapsulationPrivateKey keyEncapsulationPrivateKey)
    {
        ...
        var plainSessionKey = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_6688128_LENGTH_SHARED_SECRET);
    ...
    public IKeyEncapsulationResult Encapsulation(in IKeyEncapsulationPublicKey publicKey)
    {
        ...
        var plainSessionKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_6688128_LENGTH_SHARED_SECRET);
        var apiResult = -1;
    ...
    public IKeyEncapsulationKeyPair GenerateKeyPair()
    {
        ...
        var privateKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_6688128_LENGTH_SECRET_KEY);
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_KEM_classic_mceliece_6688128_decaps(IntPtr plainSessionKey, byte[] secretSessionKey, IntPtr privateKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_classic_mceliece_6688128_encaps(byte[] secretSessionKey, IntPtr plainSessionKey, byte[] publicKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_classic_mceliece_6688128_keypair(byte[] publicKey, IntPtr privateKey);
    }
