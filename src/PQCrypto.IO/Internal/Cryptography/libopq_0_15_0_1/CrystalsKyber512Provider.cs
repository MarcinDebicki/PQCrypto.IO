...
internal sealed class CrystalsKyber512Provider : IKeyEncapsulationProvider
{
    ...
    private static readonly int OQS_KEM_KYBER_512_LENGTH_CIPHERTEXT = 768;
    private static readonly int OQS_KEM_KYBER_512_LENGTH_PUBLIC_KEY = 800;
    private static readonly int OQS_KEM_KYBER_512_LENGTH_SECRET_KEY = 1632;
    private static readonly int OQS_KEM_KYBER_512_LENGTH_SHARED_SECRET = 32;

    public KeyEncapsulationAlgorithm KeyEncapsulationAlgorithm { get; } = KeyEncapsulationAlgorithm.CrystalsKyber512;
    public LibVersion LibVersion { get; } = LibVersion.libopq_0_15_0_1;

    static CrystalsKyber512Provider()
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            DecapsMethod = Windows.OQS_KEM_ml_kem_512_decaps;
            EncapsMethod = Windows.OQS_KEM_ml_kem_512_encaps;
            GenerateKeypairMethod = Windows.OQS_KEM_ml_kem_512_keypair;
        ...
        {
            DecapsMethod = Linux.OQS_KEM_ml_kem_512_decaps;
            EncapsMethod = Linux.OQS_KEM_ml_kem_512_encaps;
            GenerateKeypairMethod = Linux.OQS_KEM_ml_kem_512_keypair;
