...
internal sealed class CrystalsKyber1024Provider : IKeyEncapsulationProvider
{
    ...
    public IKeyEncapsulationResult Decapsulation(in IKeyEncapsulationCiphertext keyEncapsulationCiphertext, in IKeyEncapsulationPrivateKey keyEncapsulationPrivateKey)
    {
        ...
        var plainSessionKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_KYBER_1024_LENGTH_SHARED_SECRET);
    ...
    public IKeyEncapsulationKeyPair GenerateKeyPair()
    {
        ...
        var privateKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_KYBER_1024_LENGTH_SECRET_KEY);
        var apiResult = -1;
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_KEM_ml_kem_1024_decaps(IntPtr plainSessionKey, byte[] secretSessionKey, IntPtr privateKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_ml_kem_1024_encaps(byte[] secretSessionKey, IntPtr plainSessionKey, byte[] publicKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_ml_kem_1024_keypair(byte[] publicKey, IntPtr privateKey);
    }
