...
internal sealed class SphincsPlusSha2128fProvider : IDigitalSignatureProvider
{
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_SIG_sphincs_sha2_128f_simple_keypair(byte[] publicKey, byte[] secretKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_SIG_sphincs_sha2_128f_simple_sign(byte[] signature, ref nuint signatureLen, byte[] message, nuint messageLen, byte[] secretKey);
