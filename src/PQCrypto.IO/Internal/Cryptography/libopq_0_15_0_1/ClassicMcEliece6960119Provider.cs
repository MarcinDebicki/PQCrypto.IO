...
internal sealed class ClassicMcEliece6960119Provider : IKeyEncapsulationProvider
{
    ...
    public IKeyEncapsulationResult Decapsulation(in IKeyEncapsulationCiphertext keyEncapsulationCiphertext, in IKeyEncapsulationPrivateKey keyEncapsulationPrivateKey)
    {
        ...
        var plainSessionKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_6960119_LENGTH_SHARED_SECRET);
    ...
    public IKeyEncapsulationKeyPair GenerateKeyPair()
    {
        ...
        var privateKeyMemorySafe = ProtectMemoryManager.Instance.Rent(OQS_KEM_CLASSIC_MCELIECE_6960119_LENGTH_SECRET_KEY);
        var apiResult = -1;
    ...
    private static class Linux
    {
        ...
        internal static extern int OQS_KEM_classic_mceliece_6960119_decaps(IntPtr plainSessionKey, byte[] secretSessionKey, IntPtr privateKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_classic_mceliece_6960119_encaps(byte[] secretSessionKey, IntPtr plainSessionKey, byte[] publicKey);

        [DllImport(NativeLibraryPath.LINUX_PATH_0_15_0_1, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int OQS_KEM_classic_mceliece_6960119_keypair(byte[] publicKey, IntPtr privateKey);
    }
